...
//   for (let i = 0; i < )
//   if (inventory.id == id) console.log(inventory.)
// };
// console.log(inventory.id == '33' );
...
// last car means array length - 1 to get the last one
let lastCar = inventory[inventory.length - 1];
console.log(`Last car of inventory id is ${lastCar.id} car mark ${lastCar.car_make} car model ${lastCar.car_model}`);
...
let carModels = [];
// step through the inventory array to push the car model then use the sort to alphabetical order
...
let oldCars = [];
for (let i = 0; i < inventory.length; i++) {
  // check car_year less than 2000 then push to new oldCars array
  if (carYears[i] < 2000) {
    oldCars.push(carYears[i]);
  }
}
console.log("############# CAR YEARS OLDER THAN 2000 ###############");
console.log(oldCars);
console.log("#######################################################");
...
console.log("############## CAR ONLY BMW & AUDI ####################");
// console.log("All BMW & Audi cars from our inventory list" + JSON.stringify(BMWAndAudi));
console.log(`All BMW & Audi cars from our inventory list are : ${JSON.stringify(BMWAndAudi)}`);
console.log("#######################################################");